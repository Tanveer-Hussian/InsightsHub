...
import 'package:news_app/Controllers/SportsPageController.dart';
import 'package:shimmer/shimmer.dart';

class SportsNewsPage extends StatelessWidget {

  final SportsPageController controller = Get.put(SportsPageController());
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.sportsNewsList.isEmpty) {
          return const Center(child: Text('No Sports news found.'));
        }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final article = controller.sportsNewsList[index];
            return SportsCard(article);
          },
        );
      }),
    );
  ...
  Widget SportsCard(Map<String, dynamic> article) {
