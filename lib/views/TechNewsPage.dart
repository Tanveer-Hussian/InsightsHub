...
import 'package:news_app/Controllers/TechPageController.dart';
import 'package:shimmer/shimmer.dart';

class TechNewsPage extends StatelessWidget {

  final TechPageController controller = Get.put(TechPageController());
      ...
      body: Obx(() {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final article = controller.techNewsList[index];
            return TechCard(article);
          },
        );
      }),
    );
  ...
  Widget TechCard(Map<String, dynamic> article) {
